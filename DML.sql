...
insert into habitaciones (numero, libre, precio_noche, num_personas, planta, hotel_id) values (101, true, 50, 2, 1, 11);
insert into habitaciones (numero, libre, precio_noche, num_personas, planta, hotel_id) values (122, true, 68, 2, 1, 21);
insert into habitaciones (numero, libre, precio_noche, num_personas, planta, hotel_id) values (319, true, 79, 2, 3, 31);
insert into habitaciones (numero, libre, precio_noche, num_personas, planta, hotel_id) values (187, true, 123, 2, 1, 41);
insert into habitaciones (numero, libre, precio_noche, num_personas, planta, hotel_id) values (133, true, 49, 2, 1, 51);
